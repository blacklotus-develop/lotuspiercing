  ...
  return <main>
    ...
    <section className="team frame section-space"><SectionIndex index="06" label="PEOPLE" /><div className="section-title-row"><h2>The people<br />behind Black Lotus.</h2><p>Two approaches, one standard: calm, precision and respect for your body.</p></div><div className="team-grid">
      ...
      <article className="team-card" tabIndex={0}>
        ...
        <div className="team-card-summary"><h3>maky</h3><p>Professional piercer · individual styling</p><span className="team-more">HOVER FOR DETAILS</span></div>
        <div className="team-card-bio"><strong>maky</strong><p>Maky is a professional piercer with an eye for detail, aesthetics and safety. She approaches every client individually and adapts each piercing to their anatomy and personal style.</p><p>Her goal is to make the entire experience comfortable and create a piercing you will enjoy for years to come.</p></div>
      </article>
