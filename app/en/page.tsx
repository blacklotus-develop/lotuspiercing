  ...
  return <main>
    ...
    <section className="team frame section-space"><SectionIndex index="06" label="PEOPLE" /><div className="section-title-row"><h2>The people<br />behind Black Lotus.</h2><p>Two approaches, one standard: calm, precision and respect for your body.</p></div><div className="team-grid">
      <article className="team-card" tabIndex={0}>
        ...
        <details className="team-card-bio"><summary><span>MORE ABOUT ALEX</span><b>+</b></summary><div className="team-bio-content"><strong>alex</strong><p>More than 12 years of experience, thousands of completed piercings and attention to every detail. Alex is the studio founder and a professional piercer who combines technical precision with an eye for aesthetics.</p><p>Each piercing is adapted to the client’s individual anatomy. He works exclusively with high-quality jewelry and follows the highest hygiene standards. His experience and personal approach ensure a safe procedure and a result designed to stand the test of time.</p></div></details>
      </article>
      <article className="team-card" tabIndex={0}>
